...
class _matchesState extends State<matches> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    yesterday = DateFormat('EEE d MMM').format(now.subtract(new Duration(days: 1)));
    oneDayAgo = DateFormat('EEE d MMM').format(now.subtract(new Duration(days: 2)));
    twoDaysAgo = DateFormat('EEE d MMM').format(now.subtract(new Duration(days: 3)));
    ...
    twoDaysThen = DateFormat('EEE d MMM').format(now.add(new Duration(days: 3)));
    threeDayThen = DateFormat('EEE d MMM').format(now.add(new Duration(days: 4)));
    fourDayThen = DateFormat('EEE d MMM').format(now.add(new Duration(days: 5)));
    fiveDayThen = DateFormat('EEE d MMM').format(now.add(new Duration(days: 6)));
    List daysList = [
      today,
      yesterday,
      oneDayAgo,
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: [
            Tab(text: twoDaysAgo,),
            Tab(text: oneDayAgo,), Tab(
              text: "YESTERDAY",),
            Tab(text: "TODAY",),
            Tab(text: "TOMORROW",),
            Tab(text: oneDayThen,),
            Tab(text: twoDaysThen,),
            Tab(text: threeDayThen,),
            Tab(text: fourDayThen,),
            Tab(text: fiveDayThen,),
            Tab(text: "CALENDAR",),
          ],
        ),
      ),
      ...
      child: ExpansionTile(
        ...
        title: Row(
          children: [
            ...
            SizedBox(width: 10,),
            Text("LaLiga",style: TextStyle(color: Colors.black,fontSize: 16),)
          ],
        ),
        children: [
          _tileItem(),
...
List live=[
  _live('RealMadrid', 'barchlona','assets/11.jpg','assets/530.jpg'),
  _live('zamalek', 'Ahley','assets/6.jpg','assets/6.jpg'),
  _live('Enppi', 'aswan','assets/8.jpg','assets/fc.jpg'),
];
